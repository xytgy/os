...
complete -c ping4 -s C -d 'Call connect() syscall on socket creation'
...
complete -c ping4 -s e -d 'Set the identification field of ECHO_REQUEST'
complete -c ping4 -s f -d 'Flood ping.  For every ECHO_REQUEST sent a period "'
complete -c ping4 -s F -d 'IPv6 only'
complete -c ping4 -s h -d 'Show help'
complete -c ping4 -s H -d 'Force DNS name resolution for the output'
...
complete -c ping4 -s p -d 'You may specify up to 16 "pad" bytes to fill out the packet you send'
