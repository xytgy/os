...
complete -c resolvconf -l stale-data -d 'Takes a boolean parameter; used in conjunction with query'
complete -c resolvconf -l json -d 'Shows output formatted as JSON'
complete -c resolvconf -s j -d 'Short for --json=auto . sp Added in version 252'
