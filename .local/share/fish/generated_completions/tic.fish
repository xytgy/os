...
complete -c tic -s c -d 'to report cases where the terminfo values do not have an exact equivalent in …'
complete -c tic -s D -d 'tells tic to print the database locations that it knows about, and exit'
complete -c tic -s e -d 'Limit writes and translations to the comma-separated list of terminal types'
...
complete -c tic -s x -d 'Treat unknown capabilities as user-defined (see \\%user_caps(5))'
complete -c tic -s R
complete -c tic -s o
