...
complete -c slogin -s 4 -d 'Forces slogin to use IPv4 addresses only'
complete -c slogin -s 6 -d 'Forces slogin to use IPv6 addresses only'
complete -c slogin -s A -d 'Enables forwarding of connections from an authentication agent such as ssh-ag…'
complete -c slogin -s a -d 'Disables forwarding of the authentication agent connection'
...
complete -c slogin -s E -d 'Append debug logs to log_file instead of standard error'
...
complete -c slogin -s J -d 'Connect to the target host by first making an slogin connection to the jump h…'
complete -c slogin -s K -d 'Enables GSSAPI-based authentication and forwarding (delegation) of GSSAPI cre…'
complete -c slogin -s k -d 'Disables forwarding (delegation) of GSSAPI credentials to the server'
...
complete -c slogin -s P -d 'Specify a tag name that may be used to select configuration in ssh_config 5'
...
complete -c slogin -s T -d 'Disable pseudo-terminal allocation'
complete -c slogin -s t -d 'Force pseudo-terminal allocation'
complete -c slogin -s V -d 'Display the version number and exit'
...
complete -c slogin -s x -d 'Disables X11 forwarding'
