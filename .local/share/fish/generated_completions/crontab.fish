...
complete -c crontab -s h -d 'option is given, crontab shows a help message and quits immediately'
complete -c crontab -s u -d 'option is given, it specifies the name of the user whose crontab is to be use…'
complete -c crontab -s n -d 'option is given, it means "dry run": crontab examines "your" crontab for its …'
