...
complete -c snap -s s -d 'Parse the value as a string set-quota Create or update a quota group'
complete -c snap -l memory -d 'Memory quota'
complete -c snap -l cpu -d 'CPU quota'
complete -c snap -l cpu-set -d 'CPU set quota'
complete -c snap -l threads -d 'Threads quota'
complete -c snap -l journal-size -d 'Journal size quota'
complete -c snap -l journal-rate-limit -d 'Journal rate limit as <message count>/<message period>'
complete -c snap -l parent -d 'Parent quota group start Start services'
