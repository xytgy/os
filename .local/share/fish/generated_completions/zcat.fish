...
complete -c zcat -s N -l name -d 'When compressing, always save the original file name, and save the seconds pa…'
...
complete -c zcat -s t -l test -d 'Test.  Check the compressed file integrity then quit'
...
complete -c zcat -s '#' -l fast -l best -d 'Regulate the speed of compression using the specified digit  # , where  -1 or…'
