...
complete -c red -s q -l quiet -l silent -d 'suppress diagnostics written to stderr'
complete -c red -s r -l restricted -d 'run in restricted mode'
complete -c red -s s -l script -d 'suppress byte counts and \'!\' prompt'
...
complete -c red -l unsafe-names -d 'allow control characters 1-31 in file names'
