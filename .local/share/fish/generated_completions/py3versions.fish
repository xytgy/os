...
complete -c py3versions -l min-supported -d 'Show the minimum supported python3 version'
complete -c py3versions -l max-supported -d 'Show the maximum supported python3 version'
