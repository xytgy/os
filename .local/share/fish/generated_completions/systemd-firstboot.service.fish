...
complete -c 'systemd-firstboot.service' -l machine-id -d 'Set the system\\*(Aqs machine ID to the specified value'
...
complete -c 'systemd-firstboot.service' -l force -d 'Write configuration even if the relevant files already exist'
complete -c 'systemd-firstboot.service' -l reset -d 'If specified, all existing files that are configured by systemd-firstboot are…'
