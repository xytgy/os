...
complete -c reset -s m -d 'Specify a mapping from a port type to a terminal; see subsection \\*(``Termina…'
...
complete -c reset -s w -d 'Resize the window to match the size deduced via %setupterm(3NCURSES)'
