...
complete -c lsof -s E -d 'specifies that endpoint supported files should be displayed with endpoint inf…'
...
complete -c lsof -s Q -d 'ignore failed search terms'
...
complete -c lsof -s t -d 'produce terse output comprising only process identifiers (without a header), …'
