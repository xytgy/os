...
complete -c pinentry-curses -l display -l ttyname -l ttytype -l lc-ctype -l lc-messages -d 'These options are used to pass localization information to pinentry-curses'
