...
complete -c '[' -s r -d 'FILE exists and the user has read access'
...
complete -c '[' -s w -d 'FILE exists and the user has write access'
complete -c '[' -s x -d 'FILE exists and the user has execute (or search) access'
