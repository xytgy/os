...
complete -c ping6 -s C -d 'Call connect() syscall on socket creation'
...
complete -c ping6 -s e -d 'Set the identification field of ECHO_REQUEST'
complete -c ping6 -s f -d 'Flood ping.  For every ECHO_REQUEST sent a period "'
complete -c ping6 -s F -d 'IPv6 only'
complete -c ping6 -s h -d 'Show help'
complete -c ping6 -s H -d 'Force DNS name resolution for the output'
