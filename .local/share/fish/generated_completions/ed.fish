...
complete -c ed -s q -l quiet -l silent -d 'suppress diagnostics written to stderr'
complete -c ed -s r -l restricted -d 'run in restricted mode'
complete -c ed -s s -l script -d 'suppress byte counts and \'!\' prompt'
...
complete -c ed -l unsafe-names -d 'allow control characters 1-31 in file names'
