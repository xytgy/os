...
complete -c x86_64-linux-gnu-gold -l enable-linker-version -d 'Put the linker version string into the . comment section'
complete -c x86_64-linux-gnu-gold -l disable-linker-version -d 'Put the linker version string into the . note. gnu'
...
complete -c x86_64-linux-gnu-gold -l keep-files-mapped -d 'Keep files mapped across passes (default on 64bit architectures)'
complete -c x86_64-linux-gnu-gold -l no-keep-files-mapped -d 'Release mapped files after each pass (default on 32bit architectures)'
...
complete -c x86_64-linux-gnu-gold -l map-whole-files -d 'Map whole files to memory (default on 64bit architectures)'
complete -c x86_64-linux-gnu-gold -l no-map-whole-files -d 'Map relevant file parts to memory (default on 32bit architectures)'
...
complete -c x86_64-linux-gnu-gold -l package-metadata -d 'Generate package metadata note'
